...
Generally, the values of `className` and `style` props are objects in kebab-case. However, if you want to use camelCase for props, you can use the `kebab` function to convert the value to a kebab-case prop.
