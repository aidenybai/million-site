...
Open this [StackBlitz](https://stackblitz.com/github/aidenybai/million-react-compat?file=src%2FApp.jsx) or clone this [repo](https://github.com/aidenybai/million-react-compat) to get started.

[![Open in StackBlitz](https://developer.stackblitz.com/img/open_in_stackblitz.svg)](https://stackblitz.com/github/aidenybai/million-react-compat?file=src%2FApp.jsx)

Navigate to `src/App.jsx` and you should see this:
<br />
<iframe style={{ width: '100%', height: '69vh' }} src="https://stackblitz.com/github/aidenybai/million-react-compat?file=src%2FApp.jsx&embed=1&hideExplorer=1&hidedevtools=1&devtoolsheight=0"></iframe>
...
Within the `src/App.jsx` file, you can write any React code with some [limitations](https://github.com/aidenybai/million-react-compat#limitations). If you are unfamiliar with React, you can learn more about it [here](https://reactjs.org/docs/getting-started.html).
