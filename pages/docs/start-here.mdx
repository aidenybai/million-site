...
<br />
<iframe style={{ width: '100%', height: '69vh' }} src="https://stackblitz.com/github/aidenybai/million-react?file=src%2FApp.jsx&embed=1&hideExplorer=1&hidedevtools=1&devtoolsheight=0"></iframe>
