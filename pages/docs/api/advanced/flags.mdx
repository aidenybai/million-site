...
## `Flags.ELEMENT` and `Flags.ENTITY`

These flags are the required default flags. They help identify the type of object provided and invoke the default diffing algorithms.
